...
<LEGEND><b>Ваша партнёрская ссылка:</b></LEGEND><br>
<table width="100%">
	<tr align="center">
		<td><input type="text" name="refurl" value="http://<?php print $cfgURL; ?>/?ref=<?php print $login; ?>" /></td>
	</tr>
</table>


<br><br><br>
<b>Приглашенные вами рефералы:</b><br><br>
	...
	$rs		= mysql_query($sql);
		...
		while($a = mysql_fetch_array($rs)) {
			...
			if($i == 1) {
				...
				print "<tr bgcolor=\"#ffffff\" align=\"center\"><td></td><td align=\"left\" style=\"padding-left: ".$i."0px;\"><font color=\"#999999\">» ".$a['login']." ".$a['icq']."".$a['skype']."</font></td><td>-</td></tr>";
