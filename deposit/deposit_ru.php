...
print "<tr>
	<td><label style=\"width: 100%;\"><input style=\"float: left;\" type=\"radio\" name=\"plan\" id=\"plan\" value=\"".$row['id']."\" checked /> <div style=\"padding: 4px 0 4px 20px; background-color: #F7F7F7;\"><b style=\"float: center;\">".$row['name']."</b></div>";
...
<tr>
	<script language=\"JavaScript\"><!-- var per['".$row['percent']."']; var cou['".$row['days']."']; //--></script>
</tr>";
...
<tr>
	<td></td>
	<td><input style="width: 205px; margin: 10px 0 0 0" class="subm"  type="submit" value=" Открыть депозит " /></td>
</tr>
</table>
</form>
<?php 
